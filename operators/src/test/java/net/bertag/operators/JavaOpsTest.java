...
public class JavaOpsTest {
    ...
    class OpTest {
        ...
        @ParameterizedTest
        @ArgumentsSource(AddObjectArgProvider.class)
        void shouldOpNullableObject(MyData a, MyData b, MyData expectedResult) {
            // GIVEN two nullable objects `a` and `b`.
            // WHEN a.op(b) is called...
            MyData result = Ops.op(a, b, Ops::plus);
    ...
    class ApplyTest {
        ...
        @ParameterizedTest
        @ArgumentsSource(ScalableObjectArgProvider.class)
        void shouldApplyNullableObject(MyData a, Double b, MyData expectedResult) {
            // GIVEN a nullable object `obj` and a factor.
            // WHEN a.apply(b) is called...
            MyData result = Ops.apply(a, b, Ops::scale);
